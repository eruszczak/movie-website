    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=300)),
                ('picture', models.ImageField(blank=True, null=True, upload_to=shared.helpers.get_instance_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster_backdrop_title', models.ImageField(blank=True, null=True, upload_to=shared.helpers.get_instance_file_path)),
                ('poster_backdrop_user', models.ImageField(blank=True, null=True, upload_to=shared.helpers.get_instance_file_path)),
                ('poster_small', models.ImageField(blank=True, null=True, upload_to=shared.helpers.get_instance_file_path)),
                ('poster_card', models.ImageField(blank=True, null=True, upload_to=shared.helpers.get_instance_file_path)),
